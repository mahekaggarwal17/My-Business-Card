        ...
        try {
            ...
            if (nvidiaKey && nvidiaKey.trim()) {
                ...
                return {
                    status: 500,
                    jsonBody: {
                        reply: "Configuration error: Neither NVIDIA_API_KEY, AZURE_OPENAI_KEY, nor OPENAI_API_KEY is configured in Azure Portal."
                    }
                };
            }
            ...
            return {
                status: 500,
                jsonBody: {
                    reply: `Server Exception: ${error.message || error}`
                }
            };
        }
    }
